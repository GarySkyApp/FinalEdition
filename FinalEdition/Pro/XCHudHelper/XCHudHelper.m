...
- (void)showMessageWindow:(NSString *)caption
    ...
    [[[UIApplication sharedApplication] delegate].window addSubview:self.hud];
    self.hud.labelText = caption;
    self.hud.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString stringWithFormat:@"MBProgressHUD.bundle/%@", @""]]];
    self.hud.customView.bounds = CGRectMake(0, 0, 100, 100);
    self.hud.mode = MBProgressHUDModeText;
    self.hud.animationType = MBProgressHUDAnimationFade;
    self.hud.removeFromSuperViewOnHide = YES;
    self.hud.color = [UIColor colorWithWhite:1 alpha:0.8f];
